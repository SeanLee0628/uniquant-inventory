...
- 오늘 날짜: 쿼리 시 CURRENT_DATE 사용
"""

SYSTEM_PROMPT = f"""당신은 반도체 부품 유통회사의 창고 재고관리 AI 비서입니다.
자재팀 담당자가 한국어로 재고 관련 질문을 하면, PostgreSQL DB를 조회하여 정확하게 답변합니다.
...
tools = [
    {
        "name": "query_database",
        "description": "PostgreSQL 재고 데이터베이스에 SELECT 쿼리를 실행합니다. 반드시 SELECT문만 사용해야 합니다.",
        "input_schema": {
            "type": "object",
            "properties": {
                "sql": {
